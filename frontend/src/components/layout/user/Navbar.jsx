    ...
    <nav className="bg-white/95 backdrop-blur-md border-b border-gray-200/80 sticky top-0 z-50 shadow-sm">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
            ...
            <div className="relative">
              ...
              >
                <img
                  ...
                  alt="Account"
                  className="w-8 h-8 rounded-full border-2 border-alabaster"
                />
                {user?.name && (
              ...
              <AnimatePresence>
                {isDropdownOpen && (
                  <Motion.div
                    className="absolute right-0 top-full mt-2 w-64 bg-white rounded-2xl shadow-xl border border-alabaster backdrop-blur-sm"
          ...
          {/* Mobile menu button */}
          <button
            className="md:hidden p-2 rounded-xl hover:bg-platinum-100 transition-colors duration-200"
        ...
        <AnimatePresence>
          {isMobileMenuOpen && (
            <Motion.div
              className="md:hidden absolute top-16 left-0 right-0 bg-white/95 backdrop-blur-md border-b border-alabaster shadow-lg"
            ...
            >
              <div className="px-4 py-4 space-y-2">
                ...
                {/* Mobile auth section */}
                <div className="border-t border-alabaster pt-4 mt-4">
                  {isAuthenticated ? (
                    <>
                    ...
                    <Link 
                      to="/login" 
                      className="block px-4 py-3 text-slate-700 rounded-xl hover:bg-platinum-100 transition-colors duration-200"
                      onClick={() => setIsMobileMenuOpen(false)}
                    >
                      Sign In
                    </Link>
